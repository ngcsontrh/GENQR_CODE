<x-user-layout>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 ">
        ...
        <div class="container mx-auto px-4 py-8">
            <h2 class="text-3xl font-bold mb-8 text-center text-gray-800 uppercase">Thông tin tài khoản</h2>
        ...
        <!-- Form đổi mật khẩu -->
        <div class="container mx-auto px-4 py-8 ">
            <h2 class="text-3xl text-center font-bold text-gray-800 mb-8 uppercase">Đổi mật khẩu</h2>
            ...
            <form action="{{ route('user.account.change-password') }}" method="POST" class="bg-white shadow-lg rounded-lg p-8 max-w-lg mx-auto">
                ...
                <!-- Mật khẩu mới -->
                <div class="mb-6">
                    <label for="new_password" class="block text-sm font-medium text-gray-700">{{ __('Mật khẩu mới') }}</label>
                    <div class="relative">
                ...
                <div class="mb-6">
                    <label for="new_password_confirmation" class="block text-sm font-medium text-gray-700">{{ __('Xác nhận mật khẩu mới') }}</label>
                    <div class="relative">
