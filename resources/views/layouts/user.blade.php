...
<div class="md:flex hidden">
    ...
    <div class="fixed top-0 left-0 h-screen w-48 flex bg-blue-950 text-white flex-col justify-between">
        <!-- Logo / Header -->
        <a href="{{ route('home') }}" class="flex flex-col items-center py-4 border-b border-blue-700">
...
<!-- Main Content -->
<div class="md:ml-48 mx-4">
        {{ $slot }}

    <!-- Footer -->
    <footer class="bg-gray-100 py-8 px-6">
        <div class="w-full grid grid-cols-1 lg:grid-cols-3 gap-6 sm:grid-cols-2 text-center">
            <div>
                <h5 class="font-bold mb-3">Thông tin liên hệ</h5>
                <p class="mb-2"><i class="fas fa-phone-alt text-orange-500"></i> +84 86 86 85 247</p>
                <p class="mb-2"><i class="fas fa-envelope text-orange-500"></i> info@gmail.vn</p>
                <p><i class="fas fa-map-marker-alt text-orange-500"></i> Ha Noi, Vietnam</p>
            </div>
            <div>
                <h5 class="font-bold mb-3">Điều khoản</h5>
                <ul class="space-y-2">
                    <li><a href="#" class="text-gray-600 hover:text-orange-500">Điều khoản sử dụng</a></li>
                    <li><a href="#" class="text-gray-600 hover:text-orange-500">Chính sách bảo mật</a></li>
                </ul>
            </div>
            <div>
                <h5 class="font-bold mb-3">Hướng dẫn</h5>
                <ul class="space-y-2">
                    <li><a href="#" class="text-gray-600 hover:text-orange-500">Hướng dẫn thanh toán</a></li>
                    <li><a href="{{ route('contact') }}" class="text-gray-600 hover:text-orange-500">Liên hệ hỗ trợ</a></li>
                </ul>
            </div>
        </div>
        <div class="mt-8 text-center text-gray-500 flex items-center justify-center">
            <img src="{{ asset('Remove-bg_MyQR.png') }}" class="w-28">, Cloned by Bùi Thị Thanh Vân
        </div>
    </footer>
</div>
<script type="module">
